...
if __name__ == '__main__':
    ...
    try:
        while True:
            t0 = time.time()
            pcd_tensor = get_pcd(pipeline, pcd, device, color_w, color_h)

            # convert a numpy array to a point cloud
            pcd.pointspositions = o3d.core.Tensor(pcd_tensor, dtype=o3d.core.Dtype.Float32, device=deb)
